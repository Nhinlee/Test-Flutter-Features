...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
      ...
      ..loadRequest(Uri.parse('http://localhost:3000/customerlist'));
...
class SampleMenu extends StatelessWidget {
  ...
  Future<void> _onShowUserAgent() async {
    ...
    //   'window.Toaster.postMessage("User Agent: " + navigator.userAgent);',
    // );

    await webViewController.runJavaScript(
      'window.Toaster.postMessage(document.toString());',
    );

    // await webViewController.runJavaScript(
    //   'window.Toaster.postMessage(window.toString());',
    // );
  }
